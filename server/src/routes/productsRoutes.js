...
const { getProducts, getProductByIdHandler, getProductsByNameAndDescriptionHandler, getProductsByOriginHandler, getProductsByManufacturerHandler, postCreateProduct } = require('../handlers/productsHandler');
...
productsRoutes.get('/manufacturer/:manufacturer', getProductsByManufacturerHandler);
