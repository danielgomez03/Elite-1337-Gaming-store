...
const TermsConditions = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        Welcome to 1337 HARDWARE: Elite Gaming Store! These Terms & Conditions
        govern your use of our website and the purchase of products from our
        store. By accessing our website and making a purchase, you agree to
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc ml-8">
          <li>
            ...
            pricing information on our website. However, we cannot guarantee
            that all information is error-free or complete.
          </li>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc ml-8">
          <li>
            All prices listed on our website are in the specified currency and
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc ml-8">
          <li>
            We offer shipping services to the specified locations as indicated
            during the checkout process.
          </li>
          <li>
            Shipping costs and estimated delivery times may vary depending on
            the destination and selected shipping method.
          </li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc ml-8">
          <li>
            Our returns and refunds policy is outlined on our website. Please
            review this policy before making a purchase.
          </li>
        </ul>
      </div>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc ml-8">
          <li>
            ...
            trademarks, is the property of 1337 HARDWARE: Elite Gaming Store and
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc ml-8">
          <li>
            To the fullest extent permitted by law, 1337 HARDWARE: Elite Gaming
            ...
            website or the products purchased from our store.
          </li>
        </ul>
      </div>
    </div>
