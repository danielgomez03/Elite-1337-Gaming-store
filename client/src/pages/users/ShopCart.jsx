    ...
    {cart.length === 0 ? (
      ...
      <div className="flex flex-col">
              ...
              <li key={product.cartId} className="flex items-center py-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    >
                       <span className="material-symbols-rounded group-hover:text-gray-900 text-lg">🗑️</span>
                      <span ></span>
                    </button>
                  </div>
                </div>
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <button className="bg-[#FF5F00] hover:bg-[#FF8129] text-white px-4 py-2 rounded self-start">
            BUY SHOPPING CART
          </button>
        </div>
      </div>
