...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-indigo-950 to-indigo-950 via-indigo-900 to-indigo-900 relative py-8 px-56 w-full h-72 flex items-center justify-center z-10 text-white">
      <div className="relative w-full h-full flex items-center justify-center">
        <div>
          <div className="relative flex flex-col items-center justify-center pr-4">
      ...
      <p className="absolute mt-8 text-xs bottom-2">© 2023 1337 Hardware</p>
    </footer>
  );
};
